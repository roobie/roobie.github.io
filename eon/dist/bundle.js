...
var _require = __webpack_require__(/*! ./mithril-helpers */ "./src/mithril-helpers.js"),
    tags = _require.tags;
...
var dictionary = __webpack_require__(/*! ./corpi/names */ "./src/corpi/names.js").cirefalicMaleFirst();
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  m.mount(appRoot, {
    view: function view() {
      ...
      for (var i = 0; i < 20; ++i) {
        try {
          var randomWord = chain.generateWord(3, 10, disableSourceWords);
      ...
      var div = tags.div,
          h1 = tags.h1,
          h3 = tags.h3;
      return div(h1('Eon - namngenerator'), div(h3('Cirefaliska namn'), div(words.map(function (w) {
        return div(w);
      }))));
    }
  });
