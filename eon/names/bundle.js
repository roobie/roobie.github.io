...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/names/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./node_modules/foswig/lib/index.js":
/*!******************************************!*\
  !*** ./node_modules/foswig/lib/index.js ***!
  \******************************************/
/*! no static exports found */
...
/***/ "./node_modules/patchinko/constant.mjs":
/*!*********************************************!*\
  !*** ./node_modules/patchinko/constant.mjs ***!
  \*********************************************/
...
/***/ "./node_modules/patchinko/explicit.mjs":
/*!*********************************************!*\
  !*** ./node_modules/patchinko/explicit.mjs ***!
  \*********************************************/
/*! exports provided: P, S, PS, D */
/***/ (function(__webpack_module__, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/patchinko/immutable.mjs":
/*!**********************************************!*\
  !*** ./node_modules/patchinko/immutable.mjs ***!
  \**********************************************/
/*! exports provided: default */
...
/***/ "./node_modules/patchinko/index.mjs":
/*!******************************************!*\
  !*** ./node_modules/patchinko/index.mjs ***!
  \******************************************/
/*! exports provided: P, S, PS, D, immutable, constant */
/***/ (function(__webpack_module__, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _explicit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./explicit */ "./node_modules/patchinko/explicit.mjs");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "P", function() { return _explicit__WEBPACK_IMPORTED_MODULE_0__["P"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "S", function() { return _explicit__WEBPACK_IMPORTED_MODULE_0__["S"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "PS", function() { return _explicit__WEBPACK_IMPORTED_MODULE_0__["PS"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "D", function() { return _explicit__WEBPACK_IMPORTED_MODULE_0__["D"]; });

/* harmony import */ var _immutable__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./immutable */ "./node_modules/patchinko/immutable.mjs");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "immutable", function() { return _immutable__WEBPACK_IMPORTED_MODULE_1__["default"]; });

/* harmony import */ var _constant__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./constant */ "./node_modules/patchinko/constant.mjs");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "constant", function() { return _constant__WEBPACK_IMPORTED_MODULE_2__["default"]; });
...
module.exports = {
  cirefalicMaleFirst: cirefalicMaleFirst
};
...
var _require = __webpack_require__(/*! ./mithril-helpers */ "./src/names/mithril-helpers.js"),
    tags = _require.tags;

var _require2 = __webpack_require__(/*! flyd */ "./node_modules/flyd/lib/index.js"),
    stream = _require2.stream,
    scan = _require2.scan;

var _require3 = __webpack_require__(/*! patchinko */ "./node_modules/patchinko/index.mjs"),
    P = _require3.P,
    S = _require3.S,
    PS = _require3.PS,
    D = _require3.D;

var _require4 = __webpack_require__(/*! ./styles */ "./src/names/styles.js"),
    addStyle = _require4.addStyle;

var _require5 = __webpack_require__(/*! ./markov-chains.js */ "./src/names/markov-chains.js"),
    chain = _require5.chain;

var _require6 = __webpack_require__(/*! ./meiosis */ "./src/names/meiosis.js"),
    setState = _require6.setState;
...
var NameListComp = {
  ...
  actions: function actions(update) {
    return {
      addName: function addName(id, newName) {
        return setState(id, update, {
          items: S(function (l) {
...
var app = {
  initialState: P({}, {
    nameLists: [NameListComp.initialState(), NameListComp.initialState()]
  }),
  actions: function actions(update) {
    return P({}, {
  ...
  var RootComp = {
    view: function view(vnode) {
      ...
      var div = tags.div,
          h1 = tags.h1,
          h3 = tags.h3;
      return div( // h1('Eon - namngenerator'),
      div(state.nameLists.map(function (lst, n) {
        return div( // h3(n + 'Cirefaliska namn'),
        h3(n + 'INDEX'), div(lst.items.map(function (w) {
          return div(w);
        })));
      })));
    }
...
var Foswig = __webpack_require__(/*! foswig */ "./node_modules/foswig/lib/index.js"); // Create the markov chain and specify the Order of the markov chain.
...
var chain = new Foswig(2); // add words into the markov chain one at a time
// chain.addWordToChain("random")

var dictionary = __webpack_require__(/*! ./corpi/names */ "./src/names/corpi/names.js").cirefalicMaleFirst();
...
var set = __webpack_require__(/*! lodash.set */ "./node_modules/lodash.set/index.js");

var _require = __webpack_require__(/*! patchinko */ "./node_modules/patchinko/index.mjs"),
    P = _require.P,
    S = _require.S,
    PS = _require.PS,
    D = _require.D;

var wrap = function wrap(update, fn) {
  return function (id, data) {
    return update(function (state) {
      var localState = get(state, id);

      var setState = function setState(newState) {
        var patchedState = P(localState, newState);
        var retVal = set(state, id, patchedState);
        return retVal;
      };
...
var setState = function setState(id, update, patch) {
  return update(function (state) {
    var localState = get(state, id);

    var doSetState = function doSetState(newState) {
      var patchedState = P({}, localState, newState);
      var retVal = set(state, id, patchedState);
      return retVal;
    };
...
var setStateA = function setStateA(id, update, patch) {
  return update(function (state) {
    var localState = get(state, id);
...
var tags = __webpack_require__(/*! html-tags */ "./node_modules/html-tags/index.js");
